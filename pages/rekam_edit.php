			...
			<form class="form" action="rekam_update.php" name="modal-popup" enctype="multipart/form-data" method="POST" id="form-edit">
				<div class="row">
					...
					<div class="form-group">
						...
						<textarea rows="4" class="form-control border-primary" name="diagnosa" placeholder="Rincian Diagnosa" ><?php echo $row['diagnosa']; ?></textarea>
					</div>
					<div class="form-group">
						<label>Terapi</label>
						<textarea rows="4" class="form-control border-primary" name="terapi" placeholder="Rincian Terapi" ><?php echo $row['terapi']; ?></textarea>
					</div>
